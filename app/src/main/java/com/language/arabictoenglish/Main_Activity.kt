...
import com.language.arabictoenglish.Setting.Setting
import com.language.arabictoenglish.VoiceInput.Voice_Translation
...
class Main_Activity : AppCompatActivity(), MaxAdViewAdListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        interstitialAd = MaxInterstitialAd( "f75ab14a45473098", this )
...
//            StartActivity(i) }
    ...
    private fun createBannerAd1() {
        adView = MaxAdView("dc63dce04afc7c32", this)
